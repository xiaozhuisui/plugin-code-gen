...
function handleCreateList(paths, path, definitions) {
  ...
  const coloums = (0, _utils.handleColumns)(Object.entries(definitions[voName]["properties"]).map(item => _objectSpread({
    name: item[0]
  }, item[1])));
  return {
    fields,
...
function handleEditModal(paths, editPath, definitions, editMethodName) {
  var _paths$editPath, _paths$editPath2, _paths$editPath2$edit, _paths$editPath2$edit2, _paths$editPath3, _paths$editPath3$edit, _paths$editPath3$edit2, _paths$editPath3$edit3;
