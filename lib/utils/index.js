...
const handleColumns = columnList => {
  return columnList.filter(item => {
    var _ref, _ref$includes;
    return item.name && !((_ref = ["id", "modifyUserId", "bg"]) === null || _ref === void 0 ? void 0 : (_ref$includes = _ref.includes) === null || _ref$includes === void 0 ? void 0 : _ref$includes.call(_ref, item.name));
  }).map(item => {
